...
# Find the studio (to not hard-code an id)
...
# Find the movies (to not hard-code and id)
...
# Find actors (to not hardcode ids)
...
# Link Christian Bale to agent (to not hardcode ids)
